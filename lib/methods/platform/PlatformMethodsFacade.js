...
const getTokenTotalSupplyFactory = require('./getTokenTotalSupply/getTokenTotalSupplyFactory');
const getTokenContractInfoFactory = require('./getTokenContractInfoPlatform/getTokenContractInfoFactory');
const getIdentityTokenBalancesFactory = require('./getIdentityTokenBalances/getIdentityTokenBalancesFactory');
...
class PlatformMethodsFacade {
  ...
  constructor(grpcTransport) {
    ...
    this.getTokenTotalSupply = getTokenTotalSupplyFactory(grpcTransport);
    this.getTokenContractInfo = getTokenContractInfoFactory(grpcTransport);
    this.getIdentityTokenBalances = getIdentityTokenBalancesFactory(grpcTransport);
  }
}
